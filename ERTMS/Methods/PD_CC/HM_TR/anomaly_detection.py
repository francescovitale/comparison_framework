...
def get_petri_net(event_log, noise_threshold):
	...
	petri_net["network"], petri_net["initial_marking"], petri_net["final_marking"] = pdiscovery.inductive.algorithm.apply(event_log, variant=pdiscovery.heuristics.algorithm.Variants.CLASSIC, parameters=parameters)
	return petri_net
