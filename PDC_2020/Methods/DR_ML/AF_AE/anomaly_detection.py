...
if mode == "training":
	...
	ae_model = train_autoencoder(event_logs_statistics, validation_split_percentage, hidden_neurons, latent_code_dimension, epochs, run_mode)
	ae_model_recons = ae_model.predict(event_logs_statistics)
	ae_model_mse = mean_squared_error(event_logs_statistics, ae_model_recons)
	...
	if sample_time == 1:
			tm_2 = 0
			tm_2 = time.time()	
	classifications = classify_diagnoses(ae_model,ae_model_mse, all_event_logs_statistics)
	if sample_time == 1:
