...
for /l %%x in (1, 1, %nreps%) do (
	...
	python anomaly_detection.py FirstRun training %debug_mode% %sample_time% %n% %normalization_technique% %n_pca_components% %n_neighbors% %use_categorical_labels% %validation_split_percentage%
	...
	python anomaly_detection.py FirstRun inference %debug_mode% %sample_time% %n% %normalization_technique% %n_pca_components% %n_neighbors% %use_categorical_labels% %validation_split_percentage%
	...
	ren Input\FirstRun\AD\Inference\Model\n_grams_list.txt n_grams_list_%%x.txt
